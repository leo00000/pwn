...
extern const MIDL_SERVER_INFO ExpIFName_ServerInfo;

extern const RPC_DISPATCH_TABLE ExpIFName_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE ExpIFName___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x86d35949,0x83c9,0x4044,{0xb4,0x24,0xdb,0x36,0x32,0x31,0xfd,0x0c}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&ExpIFName_v1_0_DispatchTable,
    0,
    0,
    0,
    &ExpIFName_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE ExpIFName_v1_0_s_ifspec = (RPC_IF_HANDLE)& ExpIFName___RpcServerInterface;

extern const MIDL_STUB_DESC ExpIFName_StubDesc;
...
static const unsigned short ExpIFName_FormatStringOffsetTable[] =
    {
    0,
    42,
    132,
...
static const MIDL_STUB_DESC ExpIFName_StubDesc = 
    {
    (void *)& ExpIFName___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION ExpIFName_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE ExpIFName_v1_0_DispatchTable = 
    {
    20,
    (RPC_DISPATCH_FUNCTION*)ExpIFName_table
    };

static const SERVER_ROUTINE ExpIFName_ServerRoutineTable[] = 
    {
...
static const MIDL_SERVER_INFO ExpIFName_ServerInfo = 
    {
    &ExpIFName_StubDesc,
    ExpIFName_ServerRoutineTable,
    rpc__MIDL_ProcFormatString.Format,
    ExpIFName_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
