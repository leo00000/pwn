...
static const RPC_CLIENT_INTERFACE ExpIFName___RpcClientInterface =
    {
...
RPC_IF_HANDLE ExpIFName_v1_0_c_ifspec = (RPC_IF_HANDLE)& ExpIFName___RpcClientInterface;

extern const MIDL_STUB_DESC ExpIFName_StubDesc;

static RPC_BINDING_HANDLE ExpIFName__MIDL_AutoBindHandle;
